 ...
 * como nombre, fecha de nacimiento, colegio, carrera, estrato socioeconómico,
 * reconocimiento de créditos de cursos (homologación) y una foto.
 */
public class Estudiante {
	 ...
	 * @param homologacion     Indica si el estudiante ha recibido reconocimiento de créditos de cursos.
