...
<body>
<div class="container">
	<h1>Por favor llenar el formulario</h1>
	...
	<form action="EstudianteServlet" method="post"
		...
		<label for="foto">Foto:</label> <input type="file" id="foto"
			...
			name="action" value="agregar">  <input type="hidden" name="action"
		...
		<select name="carreras" id="carrera">
			...
			type="checkbox" name="homologacion"> <input class="botons" type="submit"
			value="Aceptar y agregar"> <input type="hidden"
			name="action" value="listar">
	</form>
	<a class="botons" href="bienvenida.jsp">Volver</a>
</div>
